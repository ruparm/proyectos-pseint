...
Algoritmo EjFuncionSi
	...
	Leer marca;
		    ...
		    SiNo
				si cantidad = 5 & marca=ArgentinaLuz Entonces
			...
			si cantidad = 4 & marca=ArgentinaLuz  O cantidad = 4 & marca=FelipeLamparas Entonces
			...
			si cantidad = 3 & marca=ArgentinaLuz Entonces
				descuento=(precioLampara*cantidad)*0.15;
				Mostrar "el descuento es de: $" descuento;
				total= precioLampara*cantidad-descuento;
		    SiNo
				si cantidad=3 & marca=FelipeLamparas Entonces
